...
>
  {/* Left Media Card */}
  <div className="hidden md:block w-[200px] h-[300px] bg-black rounded-xl overflow-hidden shadow-lg order-1">
    {service.leftMedia.endsWith(".mp4") ? (
      <video
        src={service.leftMedia}
        autoPlay
        muted
        loop
        playsInline
  ...
  {/* Center Service Card */}
  <div className="order-2 w-[320px] h-[440px] rounded-3xl overflow-hidden shadow-2xl border border-[#333] text-white relative">
    <div
  ...
  {/* Right Media Card */}
  <div className="hidden md:block w-[200px] h-[300px] bg-black rounded-xl overflow-hidden shadow-lg order-3">
    {service.rightMedia.endsWith(".mp4") ? (
      <video
        src={service.rightMedia}
        autoPlay
        muted
        loop
        playsInline
